...
module.exports = {
  ...
  docs: {
    ...
    components: [
      ...
      { group: 'Layout', name: 'absolute-layout', alias: '自由布局', vusion: true },
      ...
      { group: 'Selector', name: 'area', alias: '地区选择' },
      { group: 'Selector', name: 'cascader', alias: '级联选择' },
      { group: 'Selector', name: 'datetime-picker', alias: '时间选择' },
      { group: 'Selector', name: 'calendar', alias: '日期选择' },
