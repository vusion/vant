...
namespace nasl.ui {
    ...
    export class VanFieldinputOptions {
        ...
        @Prop({
            ...
            setter: {
                concept: 'EnumSelectSetter',
                options: [{ title: '文本' }, { title: '密码' }, { title: '整数' }, { title: '随机整数' }, { title: '小数' }, { title: '身份证' }],
            },
        })
