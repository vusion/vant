    ...
    export class VanButtonOptions {
        ...
        @Prop({
            ...
            setter: {
                ...
                options: [{ title: '主要按钮' }, { title: '次要按钮' }, { title: '普通按钮' }, { title: '警告操作按钮' }, { title: '次要警告操作按钮' }, { title: '危险操作按钮' }, { title: '次要危险操作按钮' }],
            },
        })
        ...
        @Prop({
            ...
            setter: {
                concept: 'EnumSelectSetter',
                options: [{ title: '大' }, { title: '中型' }, { title: '正常' }, { title: '小' }, { title: '迷你' }],
            },
        })
