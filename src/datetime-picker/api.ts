    ...
    export class VanDatetimePickerOptions {
        ...
        @Prop<VanDatetimePickerOptions, 'type'>({
            ...
            setter: {
                ...
                options: [{ title: '时间选择' }, { title: '日期选择' }, { title: '日期时间选择' }],
            },
            onChange: [
        ...
        @Prop<VanDatetimePickerOptions, 'unit'>({
            ...
            setter: {
                concept: 'EnumSelectSetter',
                options: [{ title: '日期' }, { title: '周' }, { title: '月份' }, { title: '季度' }, { title: '年份' }, { title: '分' }, { title: '秒' }],
            },
            onChange: [
        ...
        @Prop<VanDatetimePickerOptions, 'showFormatter'>({
            ...
            setter: {
                concept: 'EnumSelectSetter',
                options: [{ title: '中国（2023年7月26日）' }, { title: 'ISO（2023-07-26）' }, { title: 'US（7/26/2023）' }, { title: 'EU（26/7/2023）' }, { title: '2023-28周' }, { title: '2023年第28周' }, { title: '2023-W28' }, { title: '中国（2023年7月）' }, { title: 'ISO（2023-07）' }, { title: 'US/EU（7/2023）' }, { title: '2023年第3季度' }, { title: '2023年Q3' }, { title: '2023-Q3' }, { title: '中国（2023年）' }, { title: 'ISO（2023）' }, { title: '12: 09: 09' }, { title: '12时09分09秒' }, { title: '12: 09' }, { title: '12时09分' }, { title: '2023-07-26 12: 09: 09' }, { title: '2023年7月26日 12时09分09秒' }, { title: '2023-07-26 12: 09' }, { title: '2023年7月26日 12时09分' }],
            },
        ...
        @Prop<VanDatetimePickerOptions, 'converter'>({
            ...
            setter: {
                concept: 'EnumSelectSetter',
                options: [{ title: 'yyyy/MM/dd HH: mm: ss' }, { title: 'Unix 时间戳' }, { title: 'JSON' }, { title: 'Date 对象' }],
            },
