...
namespace nasl.ui {
    ...
    export class VanRowOptions {
        @Prop<VanRowOptions, 'type'>({
            ...
            setter: {
                ...
                options: [{ title: '正常', icon: 'layout-block', tooltip: '块级布局' }, { title: '弹性布局', icon: 'layout-flex', tooltip: '弹性布局' }],
            },
        })
        type: '-' | 'flex' = 'flex';
        ...
        @Prop({
            ...
            setter: {
                ...
                options: [{ title: '无（0）' }, { title: '小（10）' }, { title: '正常（20）' }, { title: '大（30）' }],
            },
        })
        gutter: '0' | '10' | '20' | '30' = '0';
    ...
    export class VanColOptions {
        ...
        alignment: 'start' | 'center' | 'end' | 'stretch' = 'stretch';
